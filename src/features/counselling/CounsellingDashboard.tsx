...
const INITIAL_DESTINATIONS_MASTER: DestinationCatalog[] = [
  {
    ...
    avgLivingCost: "A$29,710 / yr",
    pswvWorkRights: "2 to 4 Years (Subclass 485 PSWV)",
    acceptedEnglishTests: ["PTE Academic (58+)", "IELTS (6.5)", "TOEFL iBT"],
    popularIntakes: ["February", "July", "November"],
    intakeCycles: ["Feb 2027 (Major)", "Jul 2026 (Major)", "Nov 2026 (Mid)"],
    keyHighlights: "High minimum wage, post-study work rights, Group of Eight research institutions.",
  },
  {
    name: "United Kingdom",
    code: "GB",
    ...
    dialCode: "+44",
    region: "English Speaking",
    universitiesCount: 44,
    coursesCount: 410,
    activeProcessing: 56,
    visasApproved: 210,
    visaSuccessRate: "98.1%",
    avgTuition: "£13,000 – £22,000 / yr",
    avgLivingCost: "£1,023/mo (Outside London) / £1,334/mo (London)",
    pswvWorkRights: "2 Years Graduate Route (3 Years for PhD)",
    acceptedEnglishTests: ["IELTS Academic (6.0+)", "PTE (59+)", "Duolingo (115+)", "MOI accepted in select unis"],
    popularIntakes: ["September", "January", "May"],
    intakeCycles: ["Sep 2026 (Major)", "Jan 2027 (Major)", "May 2027 (Summer)"],
    keyHighlights: "1-year Master's degrees, Russell Group universities, fast CAS turnaround.",
  },
  {
    name: "United States",
    code: "US",
    ...
    activeProcessing: 34,
    visasApproved: 98,
    visaSuccessRate: "92.4%",
    avgTuition: "$18,000 – $35,000 / yr",
    avgLivingCost: "$12,000 – $18,000 / yr",
    pswvWorkRights: "1 Year OPT + 24 Month STEM Extension (3 Yrs Total)",
    acceptedEnglishTests: ["Duolingo (110+)", "IELTS (6.5)", "TOEFL (80+)", "PTE"],
    popularIntakes: ["Fall (August/September)", "Spring (January)", "Summer (May)"],
    intakeCycles: ["Fall Aug 2026", "Spring Jan 2027", "Summer May 2027"],
    keyHighlights: "Generous university scholarships, CPT/OPT internships, Ivy & Tier-1 state institutions.",
  },
  {
    name: "Canada",
    code: "CA",
    ...
    avgLivingCost: "C$20,635 / yr (GIC Requirement)",
    pswvWorkRights: "Up to 3 Years PGWP (Post-Graduation Work Permit)",
    acceptedEnglishTests: ["PTE Core/Academic", "IELTS (6.5)", "TOEFL"],
    popularIntakes: ["Fall (September)", "Winter (January)", "Summer (May)"],
    intakeCycles: ["Sep 2026", "Jan 2027", "May 2027"],
    keyHighlights: "Express Entry PR pathways, co-op work terms, designated learning institutions (DLI).",
  },
  {
    name: "New Zealand",
    code: "NZ",
    ...
    avgTuition: "NZ$26,000 – NZ$36,000 / yr",
    avgLivingCost: "NZ$20,000 / yr",
    pswvWorkRights: "Up to 3 Years Post-Study Work Visa",
    acceptedEnglishTests: ["PTE (58+)", "IELTS (6.0+)", "TOEFL"],
    popularIntakes: ["February", "July", "November"],
    intakeCycles: ["Feb 2027", "Jul 2026", "Nov 2026"],
    keyHighlights: "Safe & serene environment, high standard of living, spouse work rights for Master's.",
  },
  {
    name: "Germany",
    code: "DE",
    ...
    activeProcessing: 18,
    visasApproved: 64,
    visaSuccessRate: "96.9%",
    avgTuition: "€0 – €3,000 / yr (Public) | €8k–14k (Private)",
    avgLivingCost: "€11,208 / yr (Sperrkonto Blocked Account)",
    pswvWorkRights: "18 Months Job Seeking Visa (1.5 Yrs) + EU Blue Card",
    acceptedEnglishTests: ["IELTS (6.5)", "PTE (58+)", "German A1/B1 (optional/recommended)"],
    popularIntakes: ["Winter (September/October)", "Summer (March/April)"],
    intakeCycles: ["Winter Sep 2026", "Summer Mar 2027"],
    keyHighlights: "Zero or low tuition fees at state universities, engineering & automotive powerhouse.",
  },
  {
    name: "Finland",
    code: "FI",
    ...
    avgTuition: "€8,000 – €14,000 / yr (Scholarships 20%–50%)",
    avgLivingCost: "€6,720 / yr (€560/month)",
    pswvWorkRights: "2 Years Post-Study Work Permit",
    acceptedEnglishTests: ["IELTS (6.0+)", "PTE (54+)", "Duolingo (105+)"],
    popularIntakes: ["Autumn (August/September)", "Spring (January)"],
    intakeCycles: ["Aug 2026 (Joint App)", "Jan 2027"],
    keyHighlights: "Ranked happiest country in the world, family visa allowance, tech innovation hub.",
  },
  {
    name: "Malta",
    code: "MT",
    ...
    avgTuition: "€6,000 – €10,000 / yr",
    avgLivingCost: "€6,000 / yr",
    pswvWorkRights: "9 Months Stay-Back Visa",
    acceptedEnglishTests: ["IELTS (5.5+)", "PTE (50+)", "Internal English Test"],
    popularIntakes: ["October", "February", "June"],
    intakeCycles: ["Oct 2026", "Feb 2027", "Jun 2027"],
    keyHighlights: "Official English-speaking Schengen EU country, affordable tuition, 20 hrs/week part-time work.",
  },
  {
    name: "Cyprus",
    code: "CY",
    ...
    avgTuition: "€4,500 – €8,500 / yr",
    avgLivingCost: "€5,000 / yr",
    pswvWorkRights: "Post-Study Employment in EU Hospitality/IT",
    acceptedEnglishTests: ["Internal College Test", "IELTS (5.0+)", "PTE"],
    popularIntakes: ["Fall (October)", "Spring (February)", "Summer (June)"],
    intakeCycles: ["Oct 2026", "Feb 2027", "Jun 2027"],
    keyHighlights: "High visa ratio for Nepali students, pleasant Mediterranean climate, flexible admission.",
  },
  {
    name: "Sweden",
    code: "SE",
    ...
    avgTuition: "SEK 90,000 – 140,000 / yr",
    avgLivingCost: "SEK 10,000 / mo",
    pswvWorkRights: "1 Year Post-Study Work Permit",
    acceptedEnglishTests: ["IELTS (6.5)", "PTE (62)", "TOEFL (90)"],
    popularIntakes: ["Autumn (August/September)", "Spring (January)"],
    intakeCycles: ["Autumn Aug 2026", "Spring Jan 2027"],
    keyHighlights: "World leader in sustainability, English-taught programs, Swedish Institute scholarships.",
  },
  {
    name: "Belgium",
    code: "BE",
    ...
    visasApproved: 24,
    visaSuccessRate: "96.0%",
    avgTuition: "€3,500 – €9,000 / yr",
    avgLivingCost: "€9,000 / yr",
    pswvWorkRights: "12 Months Orientation Year Permit",
    acceptedEnglishTests: ["IELTS (6.5)", "PTE (58+)", "TOEFL (85)"],
    popularIntakes: ["September", "February"],
    intakeCycles: ["Sep 2026", "Feb 2027"],
    keyHighlights: "Heart of European Union (Brussels), high-quality polytechnic universities.",
  },
  {
    name: "Hungary",
    code: "HU",
    ...
    avgTuition: "€4,000 – €7,500 / yr",
    avgLivingCost: "€5,000 / yr",
    pswvWorkRights: "9 Months Career-Starter Permit",
    acceptedEnglishTests: ["IELTS (5.5+)", "PTE", "Duolingo", "Internal Test"],
    popularIntakes: ["September", "February"],
    intakeCycles: ["Sep 2026", "Feb 2027"],
    keyHighlights: "Stipendium Hungaricum scholarships, historic universities in Budapest, Schengen mobility.",
  },
  {
    name: "Netherlands",
    code: "NL",
    ...
    avgLivingCost: "€11,000 / yr",
    pswvWorkRights: "1 Year 'Zoekjaar' Orientation Year Permit",
    acceptedEnglishTests: ["IELTS (6.5)", "PTE (60+)", "TOEFL"],
    popularIntakes: ["September", "February"],
    intakeCycles: ["Sep 2026", "Feb 2027"],
    keyHighlights: "95% English proficiency among locals, global business hubs in Amsterdam & Rotterdam.",
  },
  {
    name: "Ireland",
    code: "IE",
    ...
    visasApproved: 49,
    visaSuccessRate: "97.0%",
    avgTuition: "€10,000 – €18,000 / yr",
    avgLivingCost: "€10,000 / yr",
    pswvWorkRights: "2 Years Third Level Graduate Scheme (1 Yr for Bachelor)",
    acceptedEnglishTests: ["IELTS (6.5)", "PTE (62)", "Duolingo (115)"],
    popularIntakes: ["September", "January"],
    intakeCycles: ["Sep 2026", "Jan 2027"],
    keyHighlights: "Silicon Valley of Europe (Google, Meta, Apple EU HQs in Dublin), English speaking.",
  },
  {
    name: "Japan",
    code: "JP",
    ...
    avgTuition: "¥750,000 – ¥1,200,000 / yr",
    avgLivingCost: "¥1,000,000 / yr",
    pswvWorkRights: "Designated Activities Visa (Job Hunting) + Tokutei Gino",
    acceptedEnglishTests: ["JLPT N5/N4 / NAT-TEST", "IELTS for English-taught programs"],
    popularIntakes: ["April", "October", "July", "January"],
    intakeCycles: ["Apr 2027 (Major)", "Oct 2026 (Major)", "Jul 2026", "Jan 2027"],
    keyHighlights: "28 hrs/week legal part-time work rights, high technology industry, safe environment.",
  },
  {
    name: "South Korea",
    code: "KR",
    ...
    avgTuition: "₩4,000,000 – ₩8,000,000 / sem",
    avgLivingCost: "₩7,000,000 / yr",
    pswvWorkRights: "D-10 Job Seeking Visa (Up to 2 Years) + E-7 Work Visa",
    acceptedEnglishTests: ["TOPIK Level 3+", "IELTS (5.5+ for English Track)", "Duolingo"],
    popularIntakes: ["Spring (March)", "Fall (September)"],
    intakeCycles: ["Mar 2027", "Sep 2026"],
    keyHighlights: "GKS Government scholarships, top tech conglomerates (Samsung, Hyundai, LG).",
  },
];
...
const INITIAL_PARTNER_UNIVERSITIES: PartnerUniversity[] = [
  {
    ...
    popularCourses: ["MSc International Business", "MSc Data Science", "MBA"],
    minPte: "58 (Min 51 in each band)",
    minIelts: "6.0",
    scholarship: "Up to £3,000 Early Bird & Merit Grant",
    tuition: "£16,500 / yr",
  ...
  },
  {
    ...
    country: "Australia",
    countryCode: "AU",
    ranking: "Top 1% Worldwide (#197 QS)",
    popularCourses: ["Master of Information Technology", "Master of Business Analytics", "Bachelor of Nursing"],
    minPte: "58 (No band less than 50)",
    minIelts: "6.5",
    scholarship: "25% Deakin STEM & Vice Chancellor Scholarship",
    tuition: "A$34,000 / yr",
    intake: "July 2026 & February 2027",
  },
  {
    id: "uni-3",
    ...
    popularCourses: ["MSc Computer Science", "MSc International Tourism & Hospitality", "BSc Cyber Security"],
    minPte: "59 overall",
    minIelts: "6.0",
    scholarship: "£2,000 Vice-Chancellor Excellence Grant",
    tuition: "£15,450 / yr",
    intake: "September 2026 & January 2027",
  },
  {
    ...
    popularCourses: ["MS Computer Science", "MS Global Management (Thunderbird)", "BS Engineering"],
    minPte: "58+",
    minIelts: "6.5",
    scholarship: "NAMU Merit Scholarship ($5,000 – $14,000/yr)",
    tuition: "$32,000 / yr",
    intake: "Fall August 2026",
  },
  {
    id: "uni-5",
    ...
    country: "Canada",
    countryCode: "CA",
    ranking: "Leading Canadian Polytechnic (DLI #O19395536013)",
    popularCourses: ["PG Diploma in Cloud Computing", "Project Management", "Business Analytics"],
    minPte: "60 overall",
    minIelts: "6.5",
    scholarship: "C$1,500 Renewable Academic Merit",
    tuition: "C$17,800 / yr",
    intake: "September 2026 & January 2027",
  },
  {
    ...
    country: "Finland",
    countryCode: "FI",
    ranking: "Top 350 QS World · #9 in Climate Action",
    popularCourses: ["MSc Software Engineering", "MSc Sustainable Technology", "MSc Circular Economy"],
    minPte: "54 overall",
    minIelts: "6.0",
    scholarship: "50% to 100% Tuition Waiver Grants",
    tuition: "€13,500 / yr (Before Scholarship)",
    intake: "August 2026 Autumn Intake",
  },
  {
    id: "uni-7",
    ...
    country: "Germany",
    countryCode: "DE",
    ranking: "FIBAA Accredited · 100,000+ Students",
    popularCourses: ["MBA in AI Management", "MSc Data Science", "BSc Computer Science"],
    minPte: "56 overall",
    minIelts: "6.0",
    scholarship: "Up to 50% Early Enrolment Scholarship",
    tuition: "€10,500 / yr",
    intake: "Rolling / October 2026 & April 2027",
  },
  {
    id: "uni-8",
    ...
    country: "Cyprus",
    countryCode: "CY",
    ranking: "Top 501–600 Times Higher Education",
    popularCourses: ["BSc Computer Science", "MBA", "MSc Blockchain & Digital Currency"],
    minPte: "50+",
    minIelts: "5.5",
    scholarship: "30% AECS Partner Institutional Discount",
    tuition: "€7,200 / yr",
...
export function CounsellingDashboard() {
  ...
  const [consultForm, setConsultForm] = useState({
    ...
    preferredCourse: "",
    counsellorName: profile?.full_name || "Sita Adhikari",
              ...
              {records.map((r: any) => (
                ...
                >
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", fontSize: "11px", color: "var(--text-muted)" }}>
                    ...
                    <span>Counsellor: <strong>{r.counsellorName || "Sita Adhikari"}</strong></span>
                  </div>
                </div>
              ))}
            </div>
