...
export function StudentDirectory() {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      ...
      listStudents({ search, country, status, testType, from: kathmanduBoundary(effectiveFrom), to: kathmanduBoundary(effectiveTo, true), weekdays: selectedDays, page, pageSize })
